...
def run(rank, world_size, args):
    ...
    for image in tqdm(split_images): 
        ...
        image_path = os.path.join(args.image_folder, image['image'])
...
def main(args):
    ...
    if multiprocess:
        ...
        # 获取目录
        directory = os.path.dirname(args.answer_file)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ori_processor_path", type=str, default="/home/data/wyy/checkpoints/Qwen2-VL-2B-Instruct")
    parser.add_argument("--model-path", type=str, default="/home/data/wyy/checkpoints/Qwen2-VL-2B-Instruct")
    parser.add_argument("--image-folder", type=str, default="/home/data/wyy/datasets/vg/VG_100K")
    parser.add_argument("--question-file", type=str, default="/home/data/wyy/projects/SeVa/seva/playground/data/eval/aro/parsed_vg_att.jsonl")
    parser.add_argument("--answer-file", type=str, default="/home/data/wyy/projects/Visual-RFT/eval_results/aro/Qwen2_vl_2b_base/vg_att.json")
