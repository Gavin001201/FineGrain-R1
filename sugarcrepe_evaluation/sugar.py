...
def run(rank, world_size, args):
    ...
    for question in questions:
        ...
        question['question'] = question['question'] + "Answer with option A or B."
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-folder", type=str, default="/home/data/wyy/datasets/coco2017/val2017")
    parser.add_argument("--question-file", type=str, default="/home/data/wyy/projects/SeVa/seva/playground/data/eval/sugarcrepe/parsed_sugar.jsonl")
    parser.add_argument("--answer-file", type=str, default="/home/data/wyy/projects/Visual-RFT/eval_results/sugarcrepe/Qwen2_vl_7b.json")
